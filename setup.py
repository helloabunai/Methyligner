...
setup(
    ...
    description='Alignment/Analysis pipeline for Methylated DNA sequences',
    ...
    package_data={'Methyligner': ['config/config.dtd']},
    ...
    entry_points={
        'console_scripts': ['methyligner=Methyligner.heisenberg:main',],
    },
)